		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					<h2 class="section-heading text-uppercase">Unique Beans</h2>
		...
		<div class="container">
			<div class="row">
				<div class="col-lg-12 text-center">
					...
					<h3 class="section-subheading text-muted">문의사항을 남겨주시면 답변
						드리겠습니다.</h3>
				</div>
			</div>
			<div class="row">
							...
							<div class="col-md-6">
								...
								<div class="form-group">
									<input class="form-control" id="email" type="email"
										...
										data-validation-required-message="이메일은 필수입력사항입니다.">
									<p class="help-block text-danger"></p>
								</div>
								<div class="form-group">
									<input class="form-control" id="pnum" type="pnum"
										placeholder="주문번호*" required
										data-validation-required-message="전화번호는 필수입력사항입니다.">
									<p class="help-block text-danger"></p>
								</div>
							</div>
							<div class="col-md-6">
